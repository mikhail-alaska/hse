...
func main() {
	...
	fmt.Println("Добро пожаловать в симуляцию полярного кодирования и SCL-декодирования!")
	...
	fmt.Println()
	fmt.Println("Ввод от пользователя не требуется — нажмите Enter, чтобы запустить симуляцию.")
